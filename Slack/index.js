document.addEventListener('DOMContentLoaded', function() {
    let tt__customCss = `
        body, .channel_header, #footer, .channel_title_info, #channel_topic_text, .p-message_pane .c-message_list.c-virtual_list--scrollbar > .c-scrollbar__hider, .p-classic_nav, footer, .p-classic_nav__team_header, .p-prefs_modal, .c-fullscreen_modal__header, .workspace__primary_view_footer { background: #000000 !important; }
        .p-prefs_modal .c-radiogroup .c-label--with_formatted_text { background:  rgba(255, 255, 255, 0.85); }
        .p-emoji_picker__content, .p-emoji_picker__input_container, .p-emoji_picker__list_container, .p-emoji_picker__footer, .p-emoji_picker__heading, .p-emoji_picker__preview_text, .ReactModal__Overlay--after-open .c-dialog__content, .c-dialog__header, .c-dialog__footer, .p-member_profile_card, .p-message_pane_message__message .c-message_kit__gutter, .c-message_kit__background, .lc-message_kit__background, .p-ia__view_header { background: rgb(0, 0, 0) !important;}
        .p-workspace__primary_view { border-left: 1px solid rgba(241, 93, 40, 0.45); }
        .p-workspace__input .p-message_input_field, .p-flexpane, .c-texty_autocomplete, .p-threads_footer__input .p-message_input_field { background: rgb(0, 0, 0); border-color: rgb(241, 93, 40); }
        .p-workspace__input .p-message_input_field, .p-threads_footer__input .p-message_input_field { border-color: rgba(25,255,255, 0.4); }
        .p-workspace__input .p-message_input_field.focus, .p-threads_footer__input .p-message_input_field.focus, .p-workspace__input .p-message_input_field.focus .ql-composer-sticky { border-color: rgb(241, 93, 40) !important; }
        ...
        .c-mrkdwn__code, .c-mrkdwn__pre, .c-texty_autocomplete__result_highlight, .c-texty_autocomplete__result_highlight--selected { background: rgba(29, 29, 29, 0.7) !important;}
        .c-message--highlight.c-message--editing { background: rgb(241, 93, 40);}
        .p-classic_nav__model__title__name--dim, .c-texty_input .c-texty_input__button, .p-workspace__input .p-message_input_file_button { color: rgba(255,255,255,0.3); }
        .c-message__body { color: rgb(153, 174, 177); }
        .p-message_pane__unread_banner__banner { color: #111; text-shadow: none; }
        .c-message_list__unread_divider__separator { border-color: rgb(241, 93, 40); }
        .c-message_list__unread_divider__label, .p-message_pane__unread_banner__banner, .c-mrkdwn__member--mention { background: rgb(241, 93, 40) !important; }
        .c-presence--active {color: rgb(241, 93, 40) !important;}
        #team_menu, .p-channel_sidebar, .p-team_sidebar, .p-team_sidebar--frameless::before { background: #010f1d !important; }
        nav.p-channel_sidebar .p-channel_sidebar__channel--selected, .p-channel_sidebar__link--selected, .c-message_list__day_divider__label__pill, .p-message_pane .c-message_list.c-virtual_list--scrollbar > .c-scrollbar__hider:before, .c-button--primary { color: #eee !important; background: rgb(241, 93, 40) !important; }
        .p-channel_sidebar__channel:hover { color: #eee !important; background: rgba(241, 93, 40, 0.5) !important; }
        .c-mrkdwn__member--link { background: rgb(241, 93, 40); color: rgb(0, 43, 54) !important; }
        .c-message_list__day_divider__line { border-top-color: rgba(241, 93, 40, 0.45) !important; }
        ...
        .c-message--starred , .p-channel_sidebar__static_list__item{ background: #000000; }
        #client-ui.flex_pane_showing #col_flex, #col_flex { border-left-color: #000; }
        #flex_contents, #threads_msgs_scroller_div, ts-thread, .p-threads_view .c-virtual_list__scroll_container, .c-virtual_list { background: #000000 }
        #flex_contents .heading, .p-flexpane_header, .p-flexpane__body, ts-thread .thread_messages, .p-threads_view__default_background { background: rgba(0,0,0,0.5) !important; }
